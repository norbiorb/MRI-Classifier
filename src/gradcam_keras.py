...
class GradCAM:
    ...
    def compute_heatmap(self, img_path, img_size, clf_layer_names, eps=1e-100):
        # get image array
        img_array = self.get_img_array(img_path, img_size)
        return self.compute_heatmap_by_array(img_array, clf_layer_names, eps=eps)

    def compute_heatmap_by_array(self, img_array, clf_layer_names, eps=1e-100):
        ...
        conv_model = Model(
            ...
            outputs=[last_conv_layer.get_output_at(0)]
        )
